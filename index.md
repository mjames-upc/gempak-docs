...
GEMPAK can be installed by an individual user, and root or superuser permission is not required. It's assumed for this guide and  other documentation that GEMPAK is installed for a `gempak` user account in the home directory (`/home/gempak`).

## Linux Binary

> <a href="http://www.unidata.ucar.edu/downloads/gempak/latest/gempak-7.3.0-2.x86_64.rpm"><paper-button raised="" role="button" tabindex="0"><core-icon icon="file-download" aria-label="file-download" role="img"><svg viewBox="0 0 24 24" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" fit="" style="pointer-events: none; display: block;"><g><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path></g></svg></core-icon>gempak-7.3.0-2.x86_64.rpm</paper-button></a>
>
> A Linux x86_64 binary is available from the <a href="http://www.unidata.ucar.edu/downloads/gempak/">Unidata downloads page</a>, built with gcc-gfortran 4.4.7 and Python 2.7 (required in order to use the <a href="http://python-awips.readthedocs.io/en/latest/index.html">Python AWIPS Data Access Framework</a>)


## Source code from Unidata

>  <a href="http://www.unidata.ucar.edu/downloads/gempak/latest/gempak-7.3.0.tar.gz"><paper-button raised="" role="button" tabindex="0"><core-icon icon="file-download" aria-label="file-download" role="img"><svg viewBox="0 0 24 24" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" fit="" style="pointer-events: none; display: block;"><g><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path></g></svg></core-icon>gempak7.3.0.tar.gz</paper-button></a>
>
