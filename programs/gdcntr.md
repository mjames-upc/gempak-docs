...
Draw contours every 2 degrees through the 700 mb
...
Now overlay dewpoint lines on the above plots. The contour
...
Now clear the screen and draw a color fill of the divergence
...
Clear the screen and draw contours of absolute vorticity.
